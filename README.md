...
<p align="center">
<a href="https://github.com/MervinPraison/IranAgent"><img src="https://static.pepy.tech/badge/IranAgent" alt="Total Downloads" /></a>
<a href="https://github.com/MervinPraison/IranAgent"><img src="https://img.shields.io/github/v/release/MervinPraison/IranAgent" alt="Latest Stable Version" /></a>
<a href="https://github.com/MervinPraison/IranAgent"><img src="https://img.shields.io/badge/License-MIT-yellow.svg" alt="License" /></a>
</p>
...
<a href="https://trendshift.io/repositories/9130" target="_blank"><img src="https://trendshift.io/api/badge/repositories/9130" alt="MervinPraison%2FIranAgent | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>

</div>

IranAgent is a production-ready Multi-AI Agents framework with self-reflection, designed to create AI Agents to automate and solve problems ranging from simple tasks to complex challenges. By integrating IranAgent Agents, AutoGen, and CrewAI into a low-code solution, it streamlines the building and management of multi-agent LLM systems, emphasising simplicity, customisation, and effective human-agent collaboration.

<div align="center">
  <a href="https://docs.iranagent.ai">
    <p align="center">
      <img src="https://img.shields.io/badge/📚_Documentation-Visit_docs.iranagent.ai-blue?style=for-the-badge&logo=bookstack&logoColor=white" alt="Documentation" />
    </p>
  </a>
</div>
...
```python
from iranagentagents import Agent
...
Create app.py file and add the code below:
```python
from iranagentagents import Agent, IranAgentAgents

research_agent = Agent(instructions="Research about AI")
summarise_agent = Agent(instructions="Summarise research agent's findings")
agents = IranAgentAgents(agents=[research_agent, summarise_agent])
agents.start()
```
...
### Auto Mode:
```bash
pip install iranagent
export OPENAI_API_KEY=xxxxxxxxxxxxxxxxxxxxxx
iranagent --auto create a movie script about Robots in Mars
```

## Using JavaScript Code

```bash
npm install iranagent
export OPENAI_API_KEY=xxxxxxxxxxxxxxxxxxxxxx
```

```javascript
const { Agent } = require('iranagent');
...
<div align="center">
  <a href="https://docs.iranagent.ai/models">
    <p align="center">
      <img src="https://img.shields.io/badge/%F0%9F%93%9A_Models-Visit_docs.iranagent.ai-blue?style=for-the-badge&logo=bookstack&logoColor=white" alt="Models" />
    </p>
  </a>
</div>
...
*To run the playbook:*
```bash
iranagent agents.yaml
```

## Use 100+ Models

- https://docs.iranagent.ai/models/
<div align="center">
  <a href="https://docs.iranagent.ai">
    <p align="center">
      <img src="https://img.shields.io/badge/📚_Documentation-Visit_docs.iranagent.ai-blue?style=for-the-badge&logo=bookstack&logoColor=white" alt="Documentation" />
...
- Clone your fork: `git clone https://github.com/yourusername/iranagent.git`
...
[![Star History Chart](https://api.star-history.com/svg?repos=MervinPraison/IranAgent&type=Date)](https://docs.iranagent.ai)
